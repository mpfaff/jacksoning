...
public final class NeverForgetWhatWeHadAbilityItem extends AbilityItem {
	private static final String MARKER_TAG = "NeverForgetWhatWeHad";

	public NeverForgetWhatWeHadAbilityItem(Settings settings) {
		super(settings);
	}
...
//		}
		...
		customnamepenisman.setCustomName(Text.of("Never Forget What We Had!"));
