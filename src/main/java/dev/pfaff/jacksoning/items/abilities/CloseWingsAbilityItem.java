...
public final class CloseWingsAbilityItem extends AbilityItem {
	public CloseWingsAbilityItem(Settings settings) {
		super(settings);
	}
	...
	public ActionResult useAbility(ServerWorld world, ServerPlayerEntity user, ItemStack stack, InteractionTarget target) {
		...
		customnamepenisman.setCustomName(Text.of("CloseWings"));
